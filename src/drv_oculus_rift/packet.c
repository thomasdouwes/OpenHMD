...
bool
decode_radio_address(uint8_t radio_address[5], const unsigned char* buffer, int size)
{
	if (size < 8)
		return false;
...
static bool
decode_rift_radio_message(pkt_rift_radio_message *m, const unsigned char* buffer)
{
	int i;
...
bool
decode_rift_radio_report(pkt_rift_radio_report *r, const unsigned char* buffer, int size)
{
